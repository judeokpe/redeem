...
const Mission = () => {
    return ( 
        <div className="  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 text-center px-4 md:px-10 space-x-3 py-4 ">
            <div className="bg-gradient-to-r hover:rotate-2 transition  from-green-500 to-blue-200 rounded-tl-lg p-2 mb-4">
            ...
            <div className="bg-gradient-to-r hover:rotate-2 transition  from-red-100 via-sky-500 to-blue-200 rounded-tl-lg p-2 mb-4">
                <h2>Our Vision</h2>
                <p className="pt-2">A community where all are welcomed, inspired, and equipped to live out God's purpose.</p>
                </div>
            <div className="bg-gradient-to-r hover:rotate-2 transition  from-yellow-500 via-sky-500 to-red-200 rounded-tl-lg p-2 mb-4">
                <h2>Core Values</h2>
